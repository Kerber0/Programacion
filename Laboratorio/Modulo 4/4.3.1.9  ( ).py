# Un número natural es primo si es mayor que 1 y no tiene divisores más
# que 1 y si mismo.

# ¿Complicado? De ningúna manera. Por ejemplo, 8 no es un número primo, ya que
# puedes dividirlo entre 2 y 4 (no podemos usar divisores iguales a 1 y 8, 
#                               ya que la definición lo prohíbe).
...
# el operador **. Recuerda: la raíz cuadrada de x es lo mismo que x0.5.
