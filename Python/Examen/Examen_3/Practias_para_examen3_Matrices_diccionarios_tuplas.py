...
# 9.1. Crea una matriz 3x3 y almacena la suma de cada fila en un diccionario, donde las claves sean tuplas con los índices de cada fila.
#    Ejemplo de entrada: [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
#    Salida esperada: {(0,): 6, (1,): 15, (2,): 24}
...
"""Avanzado: Matrices, diccionarios y tuplas"""



# 17.1. Crea una matriz 3x3 y almacena la suma de cada fila en un diccionario, donde las claves sean tuplas con los índices de cada fila.
#    Ejemplo de entrada: [[1, 2, 3], [4, 5, 6], [7, 8, 9]]
#    Salida esperada: {(0,): 6, (1,): 15, (2,): 24}
