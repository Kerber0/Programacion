...
public class Vista extends javax.swing.JFrame {
    ...
    // Le pasa el ActionListener (controlador) y fija el action command
    public void setControlador(java.awt.event.ActionListener c) {
        jButton1.addActionListener(c);
        jButton1.setActionCommand("SUMAR"); // nombre del comando que usará el controlador
    }

    // Devuelven los textos de los campos (los llamamos campo1 y campo2 según el layout)
    public String getCampo1() {
        return jTextField2.getText(); // en el diseño jTextField2 está a la izquierda
    }

    public String getCampo2() {
        return jTextField1.getText(); // jTextField1 está a la derecha
    }

    // Pone el texto resultado (o mensaje de error) en el JTextPane
