...
# y probada (LABORATORIO 4.1.3.6). Puede ser muy útil. Te recomendamos que 
# utilices una lista con los meses. Puedes crearla dentro de la función; 
# este truco acortará significativamente el código.

# Hemos preparado un código de prueba. Amplíalo para incluir más casos de
# prueba.
