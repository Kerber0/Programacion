...
# Las tuplas son una estructura de datos similar a las listas, pero con la diferencia de que 
# son inmutables, es decir, no se pueden modificar una vez creadas. 
